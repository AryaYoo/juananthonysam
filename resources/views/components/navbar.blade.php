        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-3">
                ...
                <button type="button" 
                        ...
                        class="theme-toggle-btn p-2 rounded-lg text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-[#222222] hover:bg-gray-200 dark:hover:bg-[#2D2D2D] border border-gray-200 dark:border-[#353535] transition-all cursor-pointer"
                        title="Ubah Mode Tampilan">
                    <!-- Sun Icon (Shows in dark mode to switch to light) -->
                    <svg class="w-4 h-4 hidden dark:block text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <!-- Moon Icon (Shows in light mode to switch to dark) -->
                    <svg class="w-4 h-4 block dark:hidden text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex items-center gap-2 md:hidden">
                ...
                <button type="button" 
                        onclick="window.toggleTheme()" 
                        aria-label="Ganti Tema (Light / Dark)"
                        class="p-2.5 rounded-lg text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-[#202020] hover:bg-gray-200 dark:hover:bg-[#2A2A2A] border border-gray-200 dark:border-[#353535] transition-all cursor-pointer focus:outline-none">
                    <svg class="w-5 h-5 hidden dark:block text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <svg class="w-5 h-5 block dark:hidden text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                    </svg>
                </button>
    ...
    <div id="mobileDrawer" 
        ...
        <div class="p-5 border-b border-gray-200 dark:border-[#262626] bg-gray-50 dark:bg-[#1A1A1A] flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <button type="button" 
                        onclick="window.toggleTheme()" 
                        class="p-2 text-gray-600 dark:text-gray-300 bg-white dark:bg-[#242424] hover:bg-gray-100 dark:hover:bg-[#2D2D2D] rounded-lg border border-gray-200 dark:border-[#353535] transition-colors cursor-pointer">
                    <svg class="w-4 h-4 hidden dark:block text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <svg class="w-4 h-4 block dark:hidden text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
