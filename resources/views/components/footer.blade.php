<footer class="bg-gray-50 dark:bg-[#0D0D0D] border-t border-gray-200 dark:border-[#222222] text-gray-600 dark:text-gray-400 transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] tracking-[0.2em] text-gray-500 dark:text-gray-400 uppercase block font-normal">
                            Gereja Keluarga
                        </span>
                    </div>
                </div>
                <p class="text-xs leading-relaxed text-gray-600 dark:text-gray-400 font-light">
                    Gereja keluarga di bawah pimpinan <strong class="text-gray-900 dark:text-white font-medium">Pastor Juan Anthony Sam</strong> & <strong class="text-gray-900 dark:text-white font-medium">Ps Samuel</strong>. Bertekad menjadi gereja yang sehat, memuridkan, dan berdampak bagi kemuliaan Kristus di kota Surabaya.
                </p>
                <div class="pt-2">
                    <span class="inline-block px-3 py-1 bg-white dark:bg-[#181818] border border-gray-200 dark:border-[#2C2C2C] rounded text-[11px] text-gray-700 dark:text-gray-300 font-light shadow-2xs">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-xs">
                    <li class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-[#222222]">
                        <span class="text-gray-600 dark:text-gray-400">Sunday Service</span>
                        <span class="font-medium text-gray-900 dark:text-white">09:00 WIB</span>
                    </li>
                    <li class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-[#222222]">
                        <span class="text-gray-600 dark:text-gray-400">Ekidz (Anak-anak)</span>
                        <span class="font-medium text-gray-900 dark:text-white">09:30 WIB</span>
                    </li>
                    <li class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-[#222222]">
                        <span class="text-gray-600 dark:text-gray-400">E-Teens (Remaja)</span>
                        <span class="font-medium text-gray-900 dark:text-white">11:00 WIB</span>
                    </li>
                    <li class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-[#222222]">
                        <span class="text-gray-600 dark:text-gray-400">Doa Senin</span>
                        <span class="font-medium text-gray-900 dark:text-white">19:00 WIB</span>
                    </li>
                    <li class="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-[#222222]">
                        <span class="text-gray-600 dark:text-gray-400">Doa Jumat</span>
                        <span class="font-medium text-gray-900 dark:text-white">19:00 WIB</span>
                    </li>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2 text-xs">
                    <p class="text-gray-600 dark:text-gray-400 flex items-start gap-2 font-light">
                        <svg class="w-4 h-4 text-gray-500 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="https://maps.google.com/?q=Jln+Ruko+Ngaglik+2+No+15+Surabaya" 
                       ...
                       class="inline-flex items-center gap-1.5 text-xs text-gray-900 dark:text-white hover:underline pt-1 font-medium">
                ...
                <div class="pt-2">
                    <a href="https://wa.me/6281213131060?text=Halo%20Pastoral%20Ekklesia%20Surabaya" 
                       target="_blank" 
                       rel="noopener noreferrer" 
                       class="w-full inline-flex items-center justify-center gap-2 py-2.5 px-3 bg-[#111111] hover:bg-[#2B2B2B] dark:bg-white dark:hover:bg-gray-100 text-white dark:text-[#111111] text-xs font-normal rounded-lg transition-all shadow-sm">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-[#222222] flex flex-wrap items-center justify-between gap-4">
        ...
        <!-- Bottom Copyright -->
        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-[#222222] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500 dark:text-gray-400 font-light">
            <div>
